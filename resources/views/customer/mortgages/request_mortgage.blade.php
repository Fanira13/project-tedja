...
@section('title', 'Request Mortgage UAS Fani 10922003')
@section('content')
    <x-nav-tedja />
...
<div class="flex justify-center gap-[30px] mt-[50px] mb-[70px]">
    <div class="relative">
        <div class="sticky top-[144px] flex flex-col w-[357px] shrink-0 h-fit rounded-[30px] ring-1 ring-tedja-border p-[10px] pb-5 gap-3 bg-white">
            <div class="thumbnail-container relative w-full h-[240px] rounded-[30px] overflow-hidden">
                <img src="{{ asset('assets/images/thumbnails/thumbnails-6.png')}}" class="w-full h-full object-cover" alt="thumbnail">
            </div>
            <div class="flex flex-col gap-[18px] px-[10px]">
                <div class="flex flex-col gap-[6px]">
                    <h3 class="font-bold text-lg">{{ $interest->house->name }}</h3>
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ Storage::url($interest->house->thumbnail) }}" class="size-5 flex shrink-0" alt="icon">
                        <p class="font-semibold text-sm">{{ $interesr->house->city->name }}</p>
                    </div>
                </div>
    ...
    <div class="flex flex-col gap-5 w-[500px] shrink-0">
            ...
            <div class="flex flex-col gap-4" id="PriceDetails">
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex items-center justify-between">
                        ...
                        <strong class="font-semibold">{{ number_format($interest->house->price, 0, '','.'); }}</strong>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/icons/note.svg')}}" alt="icon" class="size-6 shrink-0">
        ...
        <section id="Bank-Details" class="border border-[#F2F2F4] bg-white !h-fit w-full p-5 rounded-[20px] flex flex-col gap-4">
            <div class="flex items-center justify-between">
                ...
                <button type="button" class="shrink-0" data-expand="BankDetails">
                    <img src="{{ Storage::url($interest->bank->photo) }}" alt="icon" class="size-6 shrink-0 transition-all duration-300">
                </button>
            </div>
            <div class="flex flex-col gap-4" id="BankDetails">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <strong class="font-semibold">{{ $interest-duration }}</strong>
                    </div>
                </div>
            </div>
        </section>
        ...
        <form action="{{ route('front.interest.submitted') }}" method="POST" enctype="multipart/form-data" id="Request-Mortage" class="border border-[#F2F2F4] bg-white !h-fit w-full p-5 rounded-[20px] flex flex-col gap-5">
            ...
            <input type="hidden" id="interest_id" value="{{ $interest->id }}">
