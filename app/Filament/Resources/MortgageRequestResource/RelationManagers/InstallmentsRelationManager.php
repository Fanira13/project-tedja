                        ...
                        ->schema([
                            ...
                            Forms\Components\Select::make('sub_total_amount')
                                ...
                                ->afterStateUpdated(function ($state, callable $get, callable $set) {
                                    ...
                                    $set('insurance_amount', $insurance); // Pastikan nilai ini selalu ada
                                    ...
                                    if ($mortgageRequest) {
                                        ...
                                        $previousRemainingLoan = $lastInstallment ? $lastInstallment->remaining_loan_amount
                            ...
                            Forms\Components\TextInput::make('insurance_amount')
                                ...
                                ->readOnly()
                                ->required()
                                ->default(900000) // Menambahkan default value
                                ->prefix('IDR'),
